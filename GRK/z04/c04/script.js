...
function mouseDragged() {
    ...
    // drawVector(imgB, transformVector(makeIdentityMatrix(), makeVector(mouseX, mouseY)));
    drawVector(imgB, transformVector(makeTranslationMatrix(10, -5), makeVector(mouseX, mouseY)));
    // drawVector(imgB, transformVector(makeScaleMatrix(2, 0.5), makeVector(mouseX, mouseY)));
    // drawVector(imgB, transformVector(makeRotationMatrix(45), makeVector(mouseX, mouseY)));
    // drawVector(imgB, transformVector(makeShearMatrix(0.5, 0.5), makeVector(mouseX, mouseY)));
}
